...
num_epochs_for_embedding_list = [10] #number of epochs to train the word embeddings ; sugegstion: 10 (embedding_set = "False")
...
if model_file_name:
    ...
    tfidf_model_file_name = input_file_name + "tfidf_model"
    w2v_model_file_name = input_file_name + "w2v_model"
    bert_model_file_name = input_file_name + "bert_model"
...
if use_model:
    ...
    if tfidf:
        model_filename = (data_path + "/models/" + model_file_name + ".pkl")
    ...
    if w2v:
        model_filename = (data_path + "/models/" + model_file_name)
                    ...
                    for max_features in max_features_list:
                        ...
                        for ngram_range in ngram_range_list:
                            ...
                            for p_value_limit in p_value_limit_list:
                                ...
                                if save_model:
                                    pkl_filename = (data_path + "/models/" + tfidf_model_file_name + ".pkl")
