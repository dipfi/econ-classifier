...
############################################
logging_level = logging.INFO  # Recommended: logging.INFO  // Alternative: logging.DEBUG #logging.WARNING

print_charts_tables = True  # False #True # Recommended: True  // Alternative: False
##specify where
